  ...
  return (
    ...
    >
      ...
      <div
        ...
        className={`relative z-10 flex max-h-[min(94vh,920px)] w-full max-w-6xl flex-col overflow-hidden rounded-2xl border border-gray-200/90 bg-white shadow-[0_25px_50px_-12px_rgba(0,0,0,0.25)] transition duration-200 ease-out dark:border-gray-700/90 dark:bg-gray-900 dark:shadow-[0_25px_50px_-12px_rgba(0,0,0,0.5)] md:max-h-[92vh] ${
      ...
      >
        ...
        <div className="flex min-h-0 flex-1 flex-col overflow-hidden md:flex-row md:items-stretch">
          ...
          <section
            id={descriptionId}
            className="flex max-h-[min(42vh,360px)] shrink-0 flex-col overflow-y-auto overscroll-contain border-t border-gray-200/90 bg-gradient-to-b from-white to-gray-50/90 px-3 py-3 dark:border-gray-700/90 dark:from-gray-900 dark:to-gray-950/80 sm:px-4 sm:py-4 md:max-h-none md:h-full md:w-[min(100%,19rem)] md:shrink-0 md:border-l md:border-t-0 md:py-4 lg:w-80"
          >
